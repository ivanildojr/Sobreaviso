...
<html>
    ...
    <body>
        <a href="#list-fechamentos" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-fechamentos" class="content scaffold-list" role="main">
            ...
            <f:table collection="${fechamentosList}" />
