...
<html>
    ...
    <body>
        ...
        <div id="show-usuarioPerfil" class="content scaffold-show" role="main">
            ...
            <f:display bean="usuarioPerfil" />
            <g:form resource="${this.usuarioPerfil}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.usuarioPerfil}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
