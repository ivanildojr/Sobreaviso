...
<html>
    ...
    <body>
        ...
        <div id="show-escala" class="content scaffold-show" role="main">
            ...
            <f:display bean="escala" />
            <g:form resource="${this.escala}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.escala}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
