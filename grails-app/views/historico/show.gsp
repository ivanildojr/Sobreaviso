...
<html>
    ...
    <body>
        ...
        <div id="show-historico" class="content scaffold-show" role="main">
            ...
            <f:display bean="historico" />
            <g:form resource="${this.historico}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.historico}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
